...
class DestinationType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('building_business', TextType::class, array('attr' => array('maxlength' => 26), 'label' => 'Delivery Building / Business Name * ', 'required' => true))
            ->add('address', TextType::class, array('attr' => array('maxlength' => 26), 'label' => 'Delivery Address', 'required' => false))
            ->add('contact_person', TextType::class, array('attr' => array('maxlength' => 22), 'label' => 'Delivery Contact Person', 'required' => false))
            ->add('time_flag', null, array('label' => 'Change Time', 'required' => false))
            ->add('delivery_time', DateTimeType::class, array('label' => 'Requested Delivery Time', 'required' => false, 'data' => new \DateTime()))
    ...
    {
        return 'numa_cccadminbundle_destination';
    }
