...
class DealerSiteType extends AbstractType
{
    ...
    {
        $builder
            ->add('site_theme', 'choice', array('label' => "Theme", "choices" => array('Default' => "Default", "Sea" => "Sea", "Mountain" => "Mountain", "Mountain8b" => "Mountain8b", "Forest" => "Forest", "Garden" => "Garden", "Bridge" => "Bridge", "SeaCH" => "SeaCH")))
