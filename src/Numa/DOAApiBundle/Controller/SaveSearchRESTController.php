...
class SaveSearchRESTController extends Controller implements DealerSiteControllerInterface
{
    ...
    {
        $listingForm = $this->getDoctrine()->getRepository(SaveSearch::class)->findAll();
        return $listingForm;
    }
    ...
    {
        $listingForm = $this->getDoctrine()->getRepository(SaveSearch::class)->findBy(array('dealer_id' => $dealer_id),array("id"=>"desc"));
        return $listingForm;
    }
