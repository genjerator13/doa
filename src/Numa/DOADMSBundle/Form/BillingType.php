...
//                                                ))
            ...
            ->add('opteq1', null, array('label' => false, 'attr' => array('maxlength' => 8, 'size' => 4, 'ng-model' => 'opteq1')))
            ->add('opt2', null, array('label' => false, 'attr' => array('ng-model' => 'opt2')))
            ->add('opteq2', null, array('label' => false, 'attr' => array('maxlength' => 8, 'size' => 4, 'ng-model' => 'opteq2')))
            ->add('opt3', null, array('label' => false, 'attr' => array('ng-model' => 'opt3')))
            ->add('opteq3', null, array('label' => false, 'attr' => array('maxlength' => 8, 'size' => 4, 'ng-model' => 'opteq3')))
            ->add('opt4', null, array('label' => false, 'attr' => array('ng-model' => 'opt4')))
            ->add('opteq4', null, array('label' => false, 'attr' => array('maxlength' => 8, 'size' => 4, 'ng-model' => 'opteq4')))
            ->add('opt5', null, array('label' => false, 'attr' => array('ng-model' => 'opt5')))
            ->add('opteq5', null, array('label' => false, 'attr' => array('maxlength' => 8, 'size' => 4, 'ng-model' => 'opteq5')))
            ->add('opt6', null, array('label' => false, 'attr' => array('ng-model' => 'opt6')))
            ->add('opteq6', null, array('label' => false, 'attr' => array('maxlength' => 8, 'size' => 4, 'ng-model' => 'opteq6')))
            ->add('opt7', null, array('label' => false, 'attr' => array('ng-model' => 'opt7')))
            ->add('opteq7', null, array('label' => false, 'attr' => array('maxlength' => 8, 'size' => 4, 'ng-model' => 'opteq7')))
            ->add('opt8', null, array('label' => false, 'attr' => array('ng-model' => 'opt8')))
            ->add('opteq8', null, array('label' => false, 'attr' => array('maxlength' => 8, 'size' => 4, 'ng-model' => 'opteq8')))
            ->add('opt9', null, array('label' => false, 'attr' => array('ng-model' => 'opt9')))
            ->add('opteq9', null, array('label' => false, 'attr' => array('maxlength' => 8, 'size' => 4, 'ng-model' => 'opteq9')))
            ->add('opt10', null, array('label' => false, 'attr' => array('ng-model' => 'opt10')))
            ->add('opteq10', null, array('label' => false, 'attr' => array('maxlength' => 8, 'size' => 4, 'ng-model' => 'opteq10')))
            ->add('opteq11', null, array('label' => false, 'attr' => array('maxlength' => 8, 'size' => 4, 'ng-model' => 'opteq11')))
            ->add('opt11', null, array('label' => false, 'attr' => array('ng-model' => 'opt11')))
            ->add('opteq12', null, array('label' => false, 'attr' => array('maxlength' => 8, 'size' => 4, 'ng-model' => 'opteq12')))
            ->add('opt12', null, array('label' => false, 'attr' => array('ng-model' => 'opt12')))
            ->add('opteq13', null, array('label' => false, 'attr' => array('maxlength' => 8, 'size' => 4, 'ng-model' => 'opteq13')))
            ->add('opt13', null, array('label' => false, 'attr' => array('ng-model' => 'opt13')))
            ->add('opteq14', null, array('label' => false, 'attr' => array('maxlength' => 8, 'size' => 4, 'ng-model' => 'opteq14')))
            ->add('opt14', null, array('label' => false, 'attr' => array('ng-model' => 'opt14')))
            ->add('opteq15', null, array('label' => false, 'attr' => array('maxlength' => 8, 'size' => 4, 'ng-model' => 'opteq15')))
            ->add('opt15', null, array('label' => false, 'attr' => array('ng-model' => 'opt15')))
            ->add('opteq16', null, array('label' => false, 'attr' => array('maxlength' => 8, 'size' => 4, 'ng-model' => 'opteq16')))
            ->add('opt16', null, array('label' => false, 'attr' => array('ng-model' => 'opt16')))
            ->add('opteq17', null, array('label' => false, 'attr' => array('maxlength' => 8, 'size' => 4, 'ng-model' => 'opteq17')))
            ->add('opt17', null, array('label' => false, 'attr' => array('ng-model' => 'opt17')))
            ->add('opteq18', null, array('label' => false, 'attr' => array('maxlength' => 8, 'size' => 4, 'ng-model' => 'opteq18')))
            ->add('opt18', null, array('label' => false, 'attr' => array('ng-model' => 'opt18')))
            ->add('opteq19', null, array('label' => false, 'attr' => array('maxlength' => 8, 'size' => 4, 'ng-model' => 'opteq19')))
            ->add('opt19', null, array('label' => false, 'attr' => array('ng-model' => 'opt19')))
            ->add('opteq20', null, array('label' => false, 'attr' => array('maxlength' => 8, 'size' => 4, 'ng-model' => 'opteq20')))
            ->add('opt20', null, array('label' => false, 'attr' => array('ng-model' => 'opt20')))
            ->add('opteq21', null, array('label' => false, 'attr' => array('maxlength' => 8, 'size' => 4, 'ng-model' => 'opteq21')))
            ->add('opt21', null, array('label' => false, 'attr' => array('ng-model' => 'opt21')))
            ->add('opteq22', null, array('label' => false, 'attr' => array('maxlength' => 8, 'size' => 4, 'ng-model' => 'opteq22')))
            ->add('opt22', null, array('label' => false, 'attr' => array('ng-model' => 'opt22')))
            ->add('opteq23', null, array('label' => false, 'attr' => array('maxlength' => 8, 'size' => 4, 'ng-model' => 'opteq23')))
            ->add('opt23', null, array('label' => false, 'attr' => array('ng-model' => 'opt23')))
            ->add('opteq24', null, array('label' => false, 'attr' => array('maxlength' => 8, 'size' => 4, 'ng-model' => 'opteq24')))
            ->add('opt24', null, array('label' => false, 'attr' => array('ng-model' => 'opt24')))
            ->add('opteq25', null, array('label' => false, 'attr' => array('maxlength' => 8, 'size' => 4, 'ng-model' => 'opteq25')))
