...
class SaleType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder
            ...
            ->add('mechanical_1',null)
            ->add('mechanical_2',null)
            ->add('other_exp_1',null)
            ->add('other_exp_2',null)
            ->add('other_exp_3',null)
            ->add('other_exp_4',null)
            ->add('other_exp_5',null)
            ->add('other_exp_6',NumberType::class,array('required'  => false))
            ->add('other_exp_7',NumberType::class,array('required'  => false))
            ->add('total_unit_cost',null)
            ->add('net_gain',null)
            ->add('protect_pkg',null)
            ->add('warranty',null)
            ->add('doc_fees',null)
            ->add('admin_fees',null)
            ->add('insurance',null)
            ->add('life_ins',null)
            ->add('disability_ins',null)
            ->add('feverse',null,array('label'=>"Reserve"))
            ->add('misc_1',null)
            ->add('misc_2',null)
            ->add('misc_3',null)
            ->add('sales_comms',null)
            ->add('total_sale_cost',null)
            ...
            ->add('bank_commis',null)
            ->add('other_1',null)
            ->add('other_2',null)
            ->add('other_3',null)
            ->add('total_revenue',null)
            ->add('revenue_this_unit',null)
