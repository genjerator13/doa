...
class SaleType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder
            ...
            ->add('body_shop',NumberType::class,array('scale'=>2))
            ...
            ->add('other_exp_6',NumberType::class,array('scale'=>2))
            ->add('other_exp_7',NumberType::class,array('scale'=>2))
            ...
            ->add('gst_body_shop',NumberType::class,array('attr' => array('maxlength' => '10'),'scale'=>2))
            ...
            ->add('gst_other_exp_6',NumberType::class,array('attr' => array('maxlength' => '10'),'scale'=>2))
            ->add('gst_other_exp_7',NumberType::class,array('attr' => array('maxlength' => '10'),'scale'=>2))
