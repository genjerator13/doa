    ...
    $.fn.pgwSlideshow = function (options) {
        ...
        var setup = function () {
            ...
            pgwSlideshow.plugin.find('.ps-current > ul > li.elt_1 img').on('load', function () {
                ...
                updateHeight(maxHeight);
                $(".slideshow-sea .pgwSlideshow").height(maxHeight);
                $(".slideshow-sea .right").height(maxHeight);
                $(".slideshow-sea .right").css('z-index','50');
                $(".slideshow-sea .ps-list").css('z-index','900');
            });
